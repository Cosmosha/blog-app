...
**Blog App**  is a simple Ruby On Rail website, that enbles users to create posts, like and add comments to posts. 
...
```bash
git clone https://github.com/cosmosha/blog-app.git
```
